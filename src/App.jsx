  ...
  return (
    <main>
      ...
      <div id="game-container" className="highlight-player">
        <ol id="players">
         <Player name="Player 1" symbol="X" isActive={activePlayer === 'X'} changeName = {handlePlayerNameChange}/>
         <Player name="Player 2" symbol="O" isActive={activePlayer === 'O'} changeName = {handlePlayerNameChange}/>
        </ol>
